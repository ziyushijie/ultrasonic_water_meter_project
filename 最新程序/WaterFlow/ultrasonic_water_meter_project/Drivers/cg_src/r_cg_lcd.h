...
#define _09_LCD_CLOCK_FSUB_FIL_10          (0x09U) /* fSUB/2^10 or fIL/2^10 */
/* LCD clock (LCDCL) selection (LCDC05 - LCDC00) */
...
#define _02_LCD_VL3_INPUT_VALID           (0x02U) /* VL3/P125 pin buffer control valid */
#define _00_LCD_VL3_INPUT_INVALID         (0x00U) /* VL3/P125 pin buffer control invalid */
/* CAPL/P126, CAPH/P127 pins schmitt trigger buffer control (ISCCAP) */
#define _01_LCD_CAPLH_INPUT_VALID         (0x01U) /* CAPL/P126, CAPH/P127 pins buffer control valid */
#define _00_LCD_CAPLH_INPUT_INVALID       (0x00U) /* CAPL/P126, CAPH/P127 pins buffer control invalid */
