...
void R_SAU0_Create(void)
{
    ...
    NOP();
    NOP();
    //SPS0 = _0003_SAU_CK00_FCLK_3 | _0050_SAU_CK01_FCLK_5;
...
//    STPR11 = 1U;
//    STPR01 = 0U;
	_PPR_SEG_CONFIG(MBUS_USART1_TX_Priority,STPR11,STPR01);//发送中断优先级
//    /* Set INTSR1 level2 priority */
//    SRPR11 = 1U;
//    SRPR01 = 0U;
	_PPR_SEG_CONFIG(MBUS_USART1_RX_Priority,SRPR11,SRPR01);//接收中断优先级

//    /* Set INTSRE1 low priority */
//    SREPR11 = 1U;
//    SREPR01 = 1U;
	_PPR_SEG_CONFIG(MBUS_USART1_RX_ERROR_Priority,SREPR11,SREPR01);// 接收错误中断优先级
    ...
    SMR03 = _0020_SAU_SMRMN_INITIALVALUE | _8000_SAU_CLOCK_SELECT_CK01 | _0100_SAU_TRIGGER_RXD | _0000_SAU_EDGE_FALL | 
            _0002_SAU_MODE_UART | _0000_SAU_TRANSFER_END;
    SCR03 = _4000_SAU_RECEPTION | _0400_SAU_INTSRE_ENABLE | _0200_SAU_PARITY_EVEN | _0080_SAU_LSB | _0010_SAU_STOP_1 | 
            _0007_SAU_LENGTH_8;
...
//    CSIPR100 = 1U;
//    CSIPR000 = 1U;
   _PPR_SEG_CONFIG(MS1022_CSI00_Priority,CSIPR100,CSIPR000);// SPI中断优先级
...
//    STPR12 = 1U;
//    STPR02 = 0U;
	_PPR_SEG_CONFIG(MBUS_USART1_TX_Priority,STPR12,STPR02);// usart2发送完成中断优先级
	
//    /* Set INTSR2 level2 priority */
//    SRPR12 = 1U;
//    SRPR02 = 0U;
	_PPR_SEG_CONFIG(IRDA_USART2_RX_Priority,SRPR12,SRPR02);// usart2接收完成中断优先级
//    /* Set INTSRE2 low priority */
//    SREPR12 = 1U;
//    SREPR02 = 1U;
	_PPR_SEG_CONFIG(IRDA_USART2_RX_ERROR_Priority,SREPR12,SREPR02);// usart2接收错误中断优先级

    SMR10 = _0020_SAU_SMRMN_INITIALVALUE | _0000_SAU_CLOCK_SELECT_CK00 | _0000_SAU_TRIGGER_SOFTWARE | 
            _0002_SAU_MODE_UART | _0000_SAU_TRANSFER_END;
    SCR10 = _8000_SAU_TRANSMISSION | _0000_SAU_INTSRE_MASK | _0200_SAU_PARITY_EVEN | _0080_SAU_LSB | 
            _0010_SAU_STOP_1 | _0007_SAU_LENGTH_8;
    ...
    SMR11 = _0020_SAU_SMRMN_INITIALVALUE | _0000_SAU_CLOCK_SELECT_CK00 | _0100_SAU_TRIGGER_RXD | _0000_SAU_EDGE_FALL | 
            _0002_SAU_MODE_UART | _0000_SAU_TRANSFER_END;
    SCR11 = _4000_SAU_RECEPTION | _0400_SAU_INTSRE_ENABLE | _0200_SAU_PARITY_EVEN | _0080_SAU_LSB | _0010_SAU_STOP_1 | 
            _0007_SAU_LENGTH_8;
