...
#define _30_PFSEG0_DEFAULT      (0x30U) /* used the PFSEG0 default value */
...
*/
/* Port (other than segment output)/segment outputs specification of Pmn pins (PFSEGxx) */
#define _E6_PFSEG1_DEFAULT      (0xE6U) /* used the PFSEG1 default value */
...
*/
/* Port (other than segment output)/segment outputs specification of Pmn pins (PFSEGxx) */
#define _BB_PFSEG3_DEFAULT      (0xBBU) /* used the PFSEG3 default value */
...
*/
/* Port (other than segment output)/segment outputs specification of Pmn pins (PFSEGxx) */
#define _03_PFSEG4_DEFAULT      (0x03U) /* used the PFSEG4 default value */
