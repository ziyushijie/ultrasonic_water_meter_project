...
{
	return rtc_lib_it_irq_handle_one(RTCx);
}
...
{
	return rtc_lib_time_tick_init(RTCx, func_time_tick);
}
...
{
	return rtc_lib_init(RTCx, func_time_tick, ishw);
}
...
{
	return rtc_lib_set_rtctime(RTCx, Timex, ishw);
}
...
{
	return rtc_lib_get_rtctime(RTCx, ishw);
}