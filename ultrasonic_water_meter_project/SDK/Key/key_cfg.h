...
extern "C" {
	...
	#define KEY_BUTTON_ACTIVE_TIME_REPEAT_ONE			(320/KEY_BUTTON_MIN_PULSE_WIDTH)							//---单击时间
	#define KEY_BUTTON_ACTIVE_TIME_REPEAT_TWO			((KEY_BUTTON_ACTIVE_TIME_REPEAT_ONE+100)/KEY_BUTTON_MIN_PULSE_WIDTH)	//---双击时间
	#define KEY_BUTTON_ACTIVE_TIME_REPEAT_THREE			((KEY_BUTTON_ACTIVE_TIME_REPEAT_ONE+200)/KEY_BUTTON_MIN_PULSE_WIDTH)	//---三击时间
	#define KEY_BUTTON_ACTIVE_TIME_REPEAT_FOUR			((KEY_BUTTON_ACTIVE_TIME_REPEAT_ONE+300)/KEY_BUTTON_MIN_PULSE_WIDTH)	//---四击时间
	#define KEY_BUTTON_ACTIVE_TIME_REPEAT_FIVR			((KEY_BUTTON_ACTIVE_TIME_REPEAT_ONE+400)/KEY_BUTTON_MIN_PULSE_WIDTH)	//---五击时间
	#define KEY_BUTTON_ACTIVE_TIME_REPEAT_SIX			((KEY_BUTTON_ACTIVE_TIME_REPEAT_ONE+500)/KEY_BUTTON_MIN_PULSE_WIDTH)	//---六击时间
	#define KEY_BUTTON_ACTIVE_TIME_REPEAT_SEVEN			((KEY_BUTTON_ACTIVE_TIME_REPEAT_ONE+600)/KEY_BUTTON_MIN_PULSE_WIDTH)	//---七击时间
	#define KEY_BUTTON_ACTIVE_TIME_REPEAT_EIGHT			((KEY_BUTTON_ACTIVE_TIME_REPEAT_ONE+700)/KEY_BUTTON_MIN_PULSE_WIDTH)	//---八击时间
	#define KEY_BUTTON_ACTIVE_TIME_REPEAT_NINE			((KEY_BUTTON_ACTIVE_TIME_REPEAT_ONE+800)/KEY_BUTTON_MIN_PULSE_WIDTH)	//---九击时间
	#define KEY_BUTTON_ACTIVE_TIME_REPEAT_TEN			((KEY_BUTTON_ACTIVE_TIME_REPEAT_ONE+900)/KEY_BUTTON_MIN_PULSE_WIDTH)	//---十击时间
	#define KEY_BUTTON_ACTIVE_TIME_REPEAT_LONG			((KEY_BUTTON_ACTIVE_TIME_REPEAT_ONE+1000)/KEY_BUTTON_MIN_PULSE_WIDTH)	//---长按时间	
	#define KEY_BUTTON_ACTIVE_TIME_REPEAT_LONG_LONG		((KEY_BUTTON_ACTIVE_TIME_REPEAT_ONE+2000)/KEY_BUTTON_MIN_PULSE_WIDTH)	//---超长按时间
	#define KEY_BUTTON_ACTIVE_TIME_REPEAT_ERROR			((KEY_BUTTON_ACTIVE_TIME_REPEAT_ONE+20000)/KEY_BUTTON_MIN_PULSE_WIDTH)	//---按键错误
	//===定义结构体
