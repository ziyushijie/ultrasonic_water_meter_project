...
extern "C" {
	...
	void gpio_set_wait_time(GPIO_HandleType* gpio, uint32_t waittime);
	void gpio_reset_wait_time(GPIO_HandleType* gpio, uint32_t waittime);
	void gpio_toggle_wait_time(GPIO_HandleType* gpio, uint32_t waittime);
