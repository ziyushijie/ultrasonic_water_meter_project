...
extern "C" {
	...
	//===定义飞行时间采样点个数
	#define MS1022_TOF_SAMPLE_MAX_NUM					24+8
	...
	//---BIT0		1---上游信号异常，0---上游信号异常
	//---BIT1		1---上游计数器溢出，0---上游计数器正常
	//---BIT2		1---上游TDC测量单元异常，0---上游TDC测量单元异常
	//---BIT3		1---下游信号异常，0---下游信号异常
	//---BIT4		1---下游计数器溢出，0---上游计数器正常
	//---BIT5		1---下游TDC测量单元异常，0---上游TDC测量单元异常
	//---BIT6		1---状态寄存器错误，0---状态寄存器正常
	//---BIT7		1---TDC测量异常，0---TDC测量正常
	//===飞行时间结构定义
	struct _MS1022_TOF_HandleType
	{
		union_uint8_t msg_state;			//---飞行时间测量状态
